...
namespace Tag.HexaStack
{
    public class Tutorial : SerializedMonoBehaviour
    {
        ...
        [SerializeField, ShowIf(nameof(_basedOnLevel))] private List<LevelTestingType> _levelTestingTypes;
        ...
        {
            if (_basedOnLevel)
                return PlayerPersistantData.GetMainPlayerProgressData().playerGameplayLevel == _level && _levelTestingTypes.Contains(ResourceManager.Instance.CurrentTestingType);
            return true;
        }
        #endregion
