...
namespace Tag.HexaStack
{
    public class HighlighterSizeController : MonoBehaviour
    {
        ...
        public void ActiveHighlighter()
        {
            ...
            {
                var highlighter = TutorialElementHandler.Instance.GetUIHighlighterTransformByType(_highlighterType);
        ...
        {
            TutorialElementHandler.Instance.GetUIHighlighterTransformByType(_highlighterType).mainRectTransform.gameObject.SetActive(false);
