...
namespace Tag.HexaStack
{
    public class InGameLoadingView : BaseView
    {
        ...
        [SerializeField] private Localize textTipsLocalize;
        [SerializeField] private LoadingViewGridAnimationHandler gridAnimation;
        ...
        {
            textTipsLocalize.SetTerm(tips.GetRandomItemFromList());
        }
