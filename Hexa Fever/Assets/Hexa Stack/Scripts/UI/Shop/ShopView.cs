...
namespace Tag.HexaStack
{
    public class ShopView : BaseView
    {
        ...
        public DailyDealsView dailyDealsView => _dailyDealsView;
        ...
        public override void Show(Action action = null, bool isForceShow = false)
        {
            ...
            if (coinAmount >= 30)
                AnalyticsManager.Instance.LogGAEvent("ShopOpened : MoreThan30Coins");
            else
                AnalyticsManager.Instance.LogGAEvent("ShopOpened : LessThan30Coins");
