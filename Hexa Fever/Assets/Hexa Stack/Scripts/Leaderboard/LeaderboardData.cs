...
namespace Tag.HexaStack
{
    ...
    public class LeaderboardData : SerializedScriptableObject
    {
        ...
        [Space, Header("Boat Data")]
        public StringListDataSO botNamesList;
        public SpriteListDataSO botAvtarSpriteList;
        public SpriteListDataSO botFrameSpriteList;
        ...
        public Dictionary<int, RewardsDataSO> leaderboardRankRewards;
        ...
        {
            if (rank > 0 && leaderboardRankRewards.ContainsKey(rank - 1))
                return leaderboardRankRewards[rank - 1];
            return leaderboardRankRewards[-1];
        }
