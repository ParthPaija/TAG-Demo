...
namespace Tag.HexaStack
{
    public class DataManager : SerializedManager<DataManager>
    {
        ...
        public static LevelProgressData LevelProgressData
        {
            get
            {
                return PlayerPersistantData.GetLevelProgressData();
            }

            set
            {
                PlayerPersistantData.SetLevelProgressData(value);
            }
        }
        ...
        public void SaveLevelProgressData(LevelProgressData playerData)
        {
            LevelProgressData = playerData;
        }

        public void ResetCurrentSaveLevelData()
        {
            var levelProgressData = PlayerPersistantData.GetLevelProgressData();
            levelProgressData.ReSetData();
            PlayerPersistantData.SetLevelProgressData(levelProgressData);
        }
